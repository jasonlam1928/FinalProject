...
void StageSelectScene::Initialize() {
    ...
    AddNewObject(new Engine::Label("Stage 1", "pirulen.ttf", 36, halfW, halfH / 2, 0, 0, 0, 255, 0.5, 0.5));
    ...
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Stage 2", "pirulen.ttf", 36, halfW, halfH / 2 + 150, 0, 0, 0, 255, 0.5, 0.5));
    ...
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 36, halfW, halfH * 3 / 2, 0, 0, 0, 255, 0.5, 0.5));
