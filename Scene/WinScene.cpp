...
void WinScene::Initialize() {
    ...
    int halfW = w / 2;
    int halfH = h / 2;
    AddNewObject(new Engine::Image("win/WinScene.png", halfW, halfH, 0, 0, 0.5, 0.5));
    ...
    btn = new Engine::ImageButton("stage-select/ButtonIdle.png", "stage-select/ButtonHover.png", halfW - 600, halfH * 7 / 4 - 50, 400, 100);
    btn->SetOnClickCallback(std::bind(&WinScene::BackOnClick, this, 2));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Back", "pirulen.ttf", 48, halfW-400, halfH * 7 / 4, 0, 0, 0, 255, 0.5, 0.5));

    btn = new Engine::ImageButton("stage-select/ButtonIdle.png", "stage-select/ButtonHover.png", halfW + 200, halfH * 7 / 4 - 50, 400, 100);
